...
* By default, a ConfigMap will be mounted as a `readOnly` volume.
...
* By default, a Secret will be mounted as a `readOnly` volume.
...
* `readOnly`: An optional boolean value indicating whether the volume is to be
  "ControllerPublished" (attached) as read only. Default is false (with the
  exception of the `configMap` and `secret` volume types). This value is passed
